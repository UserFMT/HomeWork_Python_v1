...
to_address = Address("999888", "Москва",
                     "ул.Ленина",
                     "14a",
                     "123")
from_address = Address("777555",
                       "Владивосток",
                       "ул.Петрова",
                       "45/2",
                       "45")
...
print(f'Отправление {mailing1.track} из {mailing1.to_address.index},'
      f'{mailing1.to_address.sity}, {mailing1.to_address.street},'
      f'{mailing1.to_address.house_number} - '
      f'{mailing1.to_address.apartment_number} в '
      f'{mailing1.from_address.index},'
      f'{mailing1.from_address.sity}, {mailing1.from_address.street},'
      f'{mailing1.from_address.house_number} -'
      f'{mailing1.from_address.apartment_number}.'
