...
class Object:
    ...
    __script = {
        ...
        "insert_user": "insert into users (user_id, user_email, subject_id) "
                       "values ( %new_id, 'test_9999@com', 10)",
        "insert_student": "",
        "delete_student": "",
        "delete_user": ""
    }
    ...
    def get_table_names(self):
        return (self.__db.connect().
                dialect.get_table_names(self.__db.connect()))
    ...
    def get_new_id(self):
        return (self.__db.connect().
                execute(text(self.__script["get_id"])).first())

    def insert_user(self, new_id):
        self.__db.connect().begin()
        try:
            (self.__db.connect().
             execute(text(self.__script["insert_user"]), {"new_id": new_id}))
